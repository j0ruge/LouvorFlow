 ...
 * Normaliza Unicode (♭→b, ♯→#), extrai nota raiz (ignora m, maj, 7, /X),
 * mapeia enarmônicos e retorna o índice cromático + grafia canônica.
 ...
 * Preserva query string; substitui qualquer fragmento existente.
 * Para URLs de outros domínios, retorna a URL original sem alteração.
